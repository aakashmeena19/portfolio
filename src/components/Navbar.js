  ...
  return (
    <nav className="navbar">
      ...
      <div className={`navMenu ${showMenu ? 'show' : ''}`}>
        <Link to="intro0" spy={true} smooth={true} offset={-100} duration={500} className="Menu-item" onClick={() => setShowMenu(false)}>Home</Link>
        <Link to="about" spy={true} smooth={true} offset={-50} duration={500} className="Menu-item" onClick={() => setShowMenu(false)}>About</Link>
        <Link to="project" spy={true} smooth={true} offset={-50} duration={500} className="Menu-item" onClick={() => setShowMenu(false)}>Project</Link>
        <Link to="social" spy={true} smooth={true} offset={-50} duration={500} className="Menu-item" onClick={() => setShowMenu(false)}>Social</Link>
        <Link to="contactPage" spy={true} smooth={true} offset={-50} duration={500} className="Menu-item" onClick={() => setShowMenu(false)}>Contact</Link>
      </div>
    </nav>
  );
}
